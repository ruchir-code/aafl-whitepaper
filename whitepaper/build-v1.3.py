#!/usr/bin/env python3
"""
Build aafl-whitepaper-v1.3.html + aafl-whitepaper-v1.3.pdf

Pipeline:
  1. Pandoc converts the v1.3 markdown body to HTML
  ...
  4. WeasyPrint renders the HTML to PDF (A4)

Run with:
  DYLD_FALLBACK_LIBRARY_PATH=/opt/homebrew/lib python3 build-v1.3.py

v1.3 deltas vs build.py:
  - Source/output filenames bumped to v1.3
  - Metadata (VERSION, DATE, CITATION) updated
  - License line in cover updated from proprietary to CC BY-NC 4.0
  - Page header "AAFL v1.2" updated to "AAFL v1.3"
  - Strip-duplicate-h1 regex updated to match v1.3 byline
"""
import os
import re
import subprocess
...
SRC_MD    = ROOT / "aafl-whitepaper-v1.3.md"
OUT_HTML  = ROOT / "aafl-whitepaper-v1.3.html"
OUT_PDF   = ROOT / "aafl-whitepaper-v1.3.pdf"
FIGURES   = ROOT / "figures"
TMP       = Path("/tmp/aafl-build")
TMP.mkdir(exist_ok=True)
BODY_FRAG = TMP / "v1.3-body-fragment.html"
...
CITATION     = "Bakshi, R. (2026). AAFL: An Agent-Augmented Framework for Learning (v1.3). instructionalai.org."
LICENSE_LINE = "© Ruchir Bakshi 2026, licensed under Creative Commons Attribution-NonCommercial 4.0 International (CC BY-NC 4.0)."
...
@page {
  ...
  @top-left     { content: "AAFL v1.3"; font-family: 'Inter', sans-serif; font-size: 8pt; color: #5a6270; letter-spacing: 0.05em; }
...
<section class="cover">
  ...
  <div>
    ...
    <div class="cover-citation">
      {LICENSE_LINE} Suggested citation: {CITATION}
    </div>
  </div>
</section>
"""
...
body = re.sub(
    ...
    r'<p><strong>Ruchir Bakshi</strong> · v1\.3 · 2026-05-20</p>\s*'
    r'<hr />\s*',
    '',
    body,
    count=1,
...
# 5. Wrap Appendix B in a landscape-page section (table is wider than portrait fits)
appb_pattern = re.compile(
    r'(<h2 class="chapter-heading"[^>]*>Appendix B\..*)',
    re.DOTALL,
)
body = appb_pattern.sub(r'<section class="landscape-page">\1</section>', body)
...
<head>
<meta charset="utf-8">
<!-- AAFL v1.3 - forensic citation pass + CC BY-NC 4.0 license - 2026-05-20 -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>{DOC_TITLE} · {VERSION} · {AUTHOR}</title>
<meta name="author" content="{AUTHOR}">
<meta name="description" content="AAFL — An Agent-Augmented Framework for Learning. Judgment, gates, and workplace performance in the agent era. Independent IP, © Ruchir Bakshi 2026, licensed CC BY-NC 4.0.">
<meta name="keywords" content="instructional design, AI agents, HITL gates, workplace performance, federal training, ADDIE, agent-augmented learning, Proportional Restraint Scale, evaluation-as-spec">
